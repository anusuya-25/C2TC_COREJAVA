...
public class PrimitiveDataTypeDemo {
	...
	public static void main(String[] args) {
		...
		int minInt=-214748647;
		System.out.println("Minint range of byte is"+minInt +"Maxshort range of byte is"+maxInt);
		...
		float f=3232.141243278345f;
		double d=3456.1412345667887564465f;
